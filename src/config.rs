...
pub struct AppConfig {
    ...
    pub backend_http_pool_max_idle_per_host: usize,
    pub backend_http_pool_idle_timeout: Duration,
...
impl AppConfig {
    pub fn from_env() -> anyhow::Result<Self> {
        ...
        Ok(Self {
            ...
            backend_connect_timeout: get_duration("BACKEND_CONNECT_TIMEOUT", Duration::from_secs(2)),
            backend_http_pool_max_idle_per_host: get_usize("BACKEND_HTTP_POOL_MAX_IDLE_PER_HOST", 128),
            backend_http_pool_idle_timeout: get_duration("BACKEND_HTTP_POOL_IDLE_TIMEOUT", Duration::from_secs(30)),
            ...
            backend_max_inflight: get_usize("BACKEND_MAX_INFLIGHT", 100),
